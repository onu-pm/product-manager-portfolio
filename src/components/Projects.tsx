      ...
      <div className="mx-auto max-w-5xl">
        <div className="mb-10 flex flex-col items-start gap-3">
          ...
          <h2 className="font-display text-3xl font-bold tracking-tight text-neutral-900 md:text-4xl">
            <span className="text-burgundy-800">Work I&apos;ve actually</span>{" "}
            <span className="font-accent italic text-burgundy-500">shipped.</span>
          </h2>
          ...
          {projects.map((c, i) => (
            ...
            >
              ...
              <div className="mt-6 flex items-end justify-between gap-4">
                <p className="font-display line-clamp-2 text-sm font-bold text-burgundy-700">
        ...
        <div className="max-h-[85vh] overflow-y-auto p-7 md:p-9">
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <h3 className="font-display text-2xl font-bold text-neutral-900">{p.title}</h3>
          ...
          <div className="mt-6 grid gap-6 border-t border-burgundy-100 pt-6 md:grid-cols-2">
            <div>
              ...
              <p className="text-[15px] leading-relaxed text-neutral-600">{p.problem}</p>
            </div>
            <div>
              <h4 className="mb-2 text-xs font-bold uppercase tracking-wider text-neutral-400">
                Approach
          ...
          <div className="tint-card mt-6 rounded-xl p-5">
            ...
            <p className="text-[15px] leading-relaxed text-neutral-700">{p.outcome}</p>
            <p className="font-display mt-2 text-base font-bold text-burgundy-800">{p.metric}</p>
          </div>
